...
class PolicyNetwork(nn.Module):
    def __init__(self, num_inputs, num_actions, hidden_size, action_range=1.0, init_w=3e-3, log_std_min=-20,
                 log_std_max=2):
    ...
    def sample_action(self, ):
        a = torch.FloatTensor(self.num_actions).uniform_(0.01, 1.0)
